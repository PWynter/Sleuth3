...
Officer: 3721950
CaseNum: 402-2-60174903-3721950
...
if (det.locationX < 700  && det.locationY == 634 )
	{
		det.speedX = 0; //North
		det.speedY = -1;
	}
	
if (det.locationX < 700  && det.locationY == 447 )
	{
		det.speedX = -1; //West
		det.speedY = 0;
	}
	
if (det.locationX < 459  && det.locationY == 447 )
	{
		det.speedX = 0; //North
		det.speedY = -1;
	}
	
	if (det.locationX < 459  && det.locationY == 271  )
	{
		det.speedX = -1; //West
		det.speedY = 0;
	}
	
if (det.locationX < 208   && det.locationY == 271  )
	{
		det.speedX = 0; //North
		det.speedY = -1;
	}
	
if (det.locationX < 208   && det.locationY == 147  )
	{
		det.speedX = -1; //West
		det.speedY = 0;
	}
